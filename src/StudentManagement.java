...
public class StudentManagement implements Management {
    ...
    @Override
    public void displayStudentByFilter(List<Etudiant> students,
    ...
    @Override
    public String returnStudentsName(List<Etudiant> students,
    ...
    @Override
    public Etudiant createStudent(Supplier<Etudiant> supp) {
        return supp.get();
    }
    ...
    @Override
    public Stream<Etudiant> convertToSteam(List<Etudiant> students) {
        return students.stream();
    }
}
